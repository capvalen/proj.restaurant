...
while($row = mysqli_fetch_array($sql, MYSQLI_ASSOC))
{
	...
	$i++;
	echo '<div class="noselect panel bs-callout '.$color.' " style="margin-bottom: 10px;">
			<div class="panel-heading collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#'.$row['tpNombreWeb'].'" aria-expanded="false" aria-controls="'.$row['tpNombreWeb'].'"><h4 class="panel-title"><strong class="mayuscula"><i class="icofont icofont-chicken-fry"></i> '.$row['tipDescripcion'].'</strong> <span class="badge" style="float:right">'.$row['totalItems'].'</span></h4>
			</div>

...
<body>
<style>
	.btnMesa{margin-top: 15px; font-size: 21px;}
	.stockPlato{color: #63b03e;}
	.panel-body{padding: 0!important;}
	.h4NombreProducto{display: inline-block; margin-top: 7px!important; margin-bottom: 10px!important;}
	.h4precioProducto{display: inline-block; font-size: 15px;}
	.bs-callout .panel-title i{font-size: 26px;}
	/*.cantidadProducto{margin-right: 10px; margin-left: 10px;}*/
	.btn-NoLine{border-color: transparent;}
	/*.divUnSoloProducto:hover{color:#7a39a2!important; background-color: #7a39a2!important}*/
</style>
...
<div class="container-fluid" style="background-color: white; border-radius: 5px">
	...
	<div class="row" id="divMesas">
		<h1 class="text-center" style="color: #442e9e"><i class="icofont icofont-fast-food"></i> Ventas de Restaurant</h1>
	...
	<div class="row sr-only" id="divPedido">
		<h1 class="text-center" style="color: #442e9e"><i class="icofont icofont-bbq"></i> Pedido de mesa <small># <span id="spanNumMesa"></span></small></h1>
		<div class="col-xs-12 col-sm-6">
			...
			<div class="botonesGenerales text-center">
				...
				<button class="btn btn-lg btn-success btn-outline disabled" id="btnGuardarPedido"><i class="icofont icofont-diskette"></i> Guardar pedido</button>
			</div>
		</div>

		<div class="col-xs-12 col-sm-6">
			<h3 class="text-center"><i class="icofont icofont-food-cart"></i> Productos disponibles</h3>
			<div class="panel-body">
				<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
					<div class="panel bs-callout bs-callout-primary panel-sombreado" style="margin-bottom: 10px;">
						<div class="panel-heading collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#RegTodosPlatosEntradas" aria-expanded="false" aria-controls="RegTodosPlatosEntradas"><h4 class="panel-title"><strong class="mayusculas"><i class="icofont icofont-chicken-fry"></i> Entradas</strong></h4>
						</div>
					...
					<div class="panel bs-callout bs-callout-success panel-sombreado" style="margin-bottom: 10px;">
						<div class="panel-heading collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#RegTodosPlatosEspeciales" aria-expanded="false" aria-controls="RegTodosPlatosEspeciales"><h4 class="panel-title"><strong class="mayusculas"><i class="icofont icofont-chicken"></i> Platos especiales</strong></h4>
						</div>
					...
					<div class="panel bs-callout bs-callout-warning panel-sombreado" style="margin-bottom: 10px;">
						<div class="panel-heading collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#RegTodosBebidas" aria-expanded="false" aria-controls="RegTodosBebidas"><h4 class="panel-title"><strong class="mayusculas"><i class="icofont icofont-beer"></i> Bebidas</strong></h4>
						</div>
					...
					<div class="panel bs-callout bs-callout-info panel-sombreado" style="margin-bottom: 10px;">
						<div class="panel-heading collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#RegTodosPostres" aria-expanded="false" aria-controls="RegTodosPostres"><h4 class="panel-title"><strong class="mayusculas"><i class="icofont icofont-cup-cake"></i> Postres</strong></h4>
						</div>
	...
	<script>
		...
		$('.btnAgregarProducto').click(function () {
			...
			if($(`#regMesaCliente #${contenedor.find('.h4NombreProducto').attr('id')}`).length >0){//console.log('existe productos');
				...
				$('#regMesaCliente .panel-body').append(`<div class="divUnSoloProducto"  id="${contenedor.find('.h4NombreProducto').attr('id')}"><div class="col-xs-7"><button class="btn btn-danger btn-circle btn-NoLine btn-outline btnRemoverProducto"><i class="icofont icofont-close"></i></button> <h4 class="h4NombreProducto ${elementoProducto}" >${contenedor.find('.h4NombreProducto').text()}</h4> </div><div class="col-xs-3"><button class="btn btn-warning btn-outline btn-circle btn-NoLine btnRestarProducto"><i class="icofont icofont-minus-circle"></i></button> <span class="cantidadProducto">1</span><button class="btn btn-warning btn-outline btn-circle btn-NoLine btnSumarProducto"><i class="icofont icofont-plus-circle"></i></button></div><div class="col-xs-2"><h5 class="h4precioProducto"><span class="valorUndProducto sr-only">${contenedor.find('.valorProducto').text()}</span>S/. <span class="valorTotalProducto">${contenedor.find('.valorProducto').text()}</span></h5></div></div>`);
		...
		$('#btnGuardarPedido').click(function () { moment.locale('es');
			...
			var textoProductosBar=''; var textoProductosCocina=''; var numPedido='';
			if( $('#regMesaCliente .divUnSoloProducto').length>0 ){
				
				$.each($('#regMesaCliente .divUnSoloProducto'), function (i, dato) {
					numPedido=$(dato).find('.cantidadProducto').text();
					if($(dato).find('.h4NombreProducto').hasClass('divProdBebida')){
						textoProductosBar+=' '+numPedido+'   '+$(dato).find('.h4NombreProducto').text()+'\n';
					}else{
						textoProductosCocina+=' '+numPedido+'   '+$(dato).find('.h4NombreProducto').text()+'\n';
					}

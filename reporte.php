...
$('#btnGenerarExcel').click(function () {
	if($('#inputFechaInicio').val()!='' ){
		...
		window.location = "./php/reporteExcelv2.php?fechaIni="+moment( inicNomb, 'DD/MM/YYYY' ).format('YYYY-MM-DD')+"&fechaFin="+moment( finNomb, 'DD/MM/YYYY' ).format('YYYY-MM-DD')+"&hoy="+moment().format('DD/MM/YYYY h:m a')
		/* 

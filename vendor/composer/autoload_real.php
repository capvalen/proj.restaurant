...
class ComposerAutoloaderInit65bb91ee4e77771b08210b6d22bf2609
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit65bb91ee4e77771b08210b6d22bf2609::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire65bb91ee4e77771b08210b6d22bf2609($fileIdentifier, $file);
        }
...
function composerRequire65bb91ee4e77771b08210b6d22bf2609($fileIdentifier, $file)
{

...
<body>
						...
						<div id="navbar" class="navbar-collapse collapse ">
							...
							<ul class="nav navbar-nav pull-right">
								...
								<li id="liDatosPersonales"><a href="#!">
										<p><strong>Usuario: </strong> <span class="mayuscula" id="menuNombreUsuario"><?php echo $_SESSION["Atiende"]; ?></span></p><small class="text-center" id="menuFecha"><span id="fechaServer"></span> <span id="horaServer"><?php require('php/gethora.php') ?></span> </small>
									</a></li>
					...
					<div class="col-lg-12 contenedorDeslizable">
						...
						if ($_SESSION['licencia'] == 'Ok') { ?>
							...
							<div class="row divMesas "> <span class="hidden" id="spanTipoCliente"></span>
								...
								<div class="col-xs-6 col-sm-3"><button class="btn btn-azul btn-lg btn-block btn-outline btnMesa btnSinBorde" id="11"><i class="icofont icofont-restaurant-menu"></i> Delivery 1</button></div>
								<div class="col-xs-6 col-sm-3"><button class="btn btn-azul btn-lg btn-block btn-outline btnMesa btnSinBorde" id="12"><i class="icofont icofont-restaurant-menu"></i> Delivery 2</button></div>
								<div class="col-xs-6 col-sm-3"><button class="btn btn-azul btn-lg btn-block btn-outline btnMesa btnSinBorde" id="13"><i class="icofont icofont-restaurant-menu"></i> Delivery 3</button></div>
								<div class="col-xs-6 col-sm-3"><button class="btn btn-azul btn-lg btn-block btn-outline btnMesa btnSinBorde" id="14"><i class="icofont icofont-restaurant-menu"></i> Delivery 4</button></div>
								<div class="col-xs-6 col-sm-3"><button class="btn btn-azul btn-lg btn-block btn-outline btnMesa btnSinBorde" id="15"><i class="icofont icofont-restaurant-menu"></i> Delivery 5</button></div>
								<div class="col-xs-6 col-sm-3"><button class="btn btn-azul btn-lg btn-block btn-outline btnMesa btnSinBorde" id="16"><i class="icofont icofont-restaurant-menu"></i> Delivery 6</button></div>
								<div class="col-xs-6 col-sm-3"><button class="btn btn-azul btn-lg btn-block btn-outline btnMesa btnSinBorde" id="17"><i class="icofont icofont-restaurant-menu"></i> Delivery 7</button></div>
								<div class="col-xs-6 col-sm-3"><button class="btn btn-azul btn-lg btn-block btn-outline btnMesa btnSinBorde" id="18"><i class="icofont icofont-restaurant-menu"></i> Delivery 8</button></div>
								<div class="col-xs-6 col-sm-3"><button class="btn btn-azul btn-lg btn-block btn-outline btnMesa btnSinBorde" id="19"><i class="icofont icofont-restaurant-menu"></i> Delivery 9</button></div>
								<div class="col-xs-6 col-sm-3"><button class="btn btn-azul btn-lg btn-block btn-outline btnMesa btnSinBorde" id="20"><i class="icofont icofont-restaurant-menu"></i> Delivery 10</button></div>
								...
								<div class="col-xs-12 col-sm-9">
									...
									<div class="row obsMesa">
										<div class="col-xs-6"><label for="">Observaciones para Cocina:</label>
											<p class="mayuscula" id="pDetCocina"></p>
										</div>
										<div class="col-xs-6"><label for="">Observaciones para Bar:</label>
											<p class="mayuscula" id="pDetBar"></p>
										</div>
									</div>
									<div class="row">
										<div class="col-xs-6 text" style="padding-left: 45px;">
											<h4>Producto</h4>
										</div>
		...
		<div class="modal-dialog " role="document">
			<div class="modal-content">
				...
				<div class="modal-body text-center">
					...
					<div>
						<h3 style="display: inline-block; margin-top: 0px; margin-bottom: 0px;">S/. </h3>
						<h3 id="h3CuentaFinal2" style="display: inline-block;margin-top: 0px; margin-bottom: 0px;">0.00</h3>
					</div>
				...
				<div class="modal-footer"> <button class="btn btn-danger btn-outline" data-dismiss="modal"><i class="icofont icofont-close"></i> Cancelar</button>
					<button class="btn btn-primary btn-outline" id="btbSalvarVentaTarjeta"><i class="icofont icofont-save"></i> Guardar</button>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="modal-dialog " role="document">
			<div class="modal-content">
					...
					<div class="row">
						<div class="col-xs-8 col-xs-offset-2">
							...
							<select class="form-control" id="sltComprobanteEfectivo">
								<option selected value="0">Venta interna</option>
				...
				<div class="modal-footer">
					<button class="btn btn-success btn-outline" id="btnSiguientePaso"><i class="icofont icofont-simple-right"></i> Siguiente</button>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="text-center">
						<h3 style="display: inline-block; margin-top: 0px; margin-bottom: 0px;">S/. </h3>
						<h3 id="h3CuentaFinal" style="display: inline-block;margin-top: 0px; margin-bottom: 0px;">0.00</h3>
					</div>
				...
				<div class="modal-footer"> <button class="btn btn-danger btn-outline" data-dismiss="modal"><i class="icofont icofont-close"></i> Cancelar</button>
					<button class="btn btn-primary btn-outline" id="btbSalvarVenta"><i class="icofont icofont-save"></i> Guardar</button>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="text-center">
						<h3 style="display: inline-block; margin-top: 0px; margin-bottom: 0px;">S/. </h3>
						<h3 id="h3VueltoFinal" style="display: inline-block;margin-top: 0px; margin-bottom: 0px;">0</h3>
					</div>
					<div class="modal-footer">
	...
	<script>
		...
		$('#btnObtenerEstadoMesas').click(function() {
			$.ajax({
				url: 'php/retornarMesaEstado.php',
				type: 'POST'
			}).done(function(resp) {
				//console.log(resp)
		...
		$('.btnMesa').click(function() {
			if ($(this).hasClass('mesaOcupado')) {
				...
				$.ajax({
					url: 'php/listarPedidoMesaOcupada.php',
					type: 'POST',
					data: {
						mesa: iddeMesa
					}
					...
					$.each(JSON.parse(resp), function(i, dato) {
						console.log(dato)
						if (dato.observacCocina == '') {
							$('#pDetCocina').parent().addClass('hidden');
						} else {
							$('#pDetCocina').text(dato.observacCocina).parent().removeClass('hidden');
						}
						if (dato.observacBar == '') {
							$('#pDetBar').parent().addClass('hidden');
						} else {
							$('#pDetBar').text(dato.observacBar).parent().removeClass('hidden');
						}
		...
		$('body').on('click', '.btnRemoverProducto', function() {
			...
			if (cantDivs == 1) {
				...
				if (padre.hasClass('divUnSoloDescuento')) {
					$.ajax({
						url: 'php/eliminarDescuentoPedido.php',
						type: "POST",
						data: {
							idPed: $('#idPedidoMesa').text(),
							idProd: idEliminar,
							descto: padre.find('.valorUndProducto').text(),
							id: idNotaPedido
						}
					...
					$.ajax({
						url: 'php/eliminarProductoPedido.php',
						type: "POST",
						data: {
							idProd: idEliminar,
							mesa: $('#idMesaSpan').text(),
		...
		function imprimirCajaCuenta() { //console.log('hola')
			...
			$.each($('.divUnSoloProducto'), function(i, dato) {
				$.ticket.push({
					'id': $(dato).find('.h4NombreProducto').attr('id'),
					'nomProducto': $(dato).find('.cantidadProducto').text() + ' Und. ' + $(dato).find('.h4NombreProducto').text(),
					'cant': $(dato).find('.cantidadProducto').text(),
					'sub': $(dato).find('.valorTotalProducto').text()
				});
			});
			var fecha = moment().format('DD/MM/YYYY H:mm a');

			$.ajax({
				url: 'printTicketCaja.php',
				type: 'POST',
				data: {
					numMesa: $('#idMesaSpan').text(),
					hora: fecha,
					texto: retornarCadenaImprimir(),
					usuario: $.JsonUsuario.usuNombres,
					cuentaTotal: $('#idTotalSpan').text(),
					paga: $('#txtCuantPagaClienteTarjet').val(),
					cambio: '0.00'
				}
			});
		}
		$('#btbSalvarVentaTarjeta').click(function() {
			...
			if ($('#txtCuantPagaClienteTarjet').val() == '') {
				...
				$('.modal-finalizarPedidoAVentaTarjeta .labelError').removeClass('hidden').find('.mensaje').text('Debe selecionar una tarjeta.');
				...
				if (!$.creandoFactura) {
					...
					$.ajax({
						url: 'php/insertarVentaFinalTarjeta.php',
						type: 'POST',
						data: {
							mesa: $('#idMesaSpan').text(),
							idUser: $.JsonUsuario.idUsuario,
							idCli: 1, //$('#spanTipoCliente').text(), 
							montoTotal: $('#idTotalSpan').text(),
							idModo: idMod,
							pagaTarj: $('#txtCuantPagaClienteTarjet').val(),
							pagaEfe: $('#txtCuantPagaClienteEfect').val()
						}
					}).done(function(resp) {
						console.log(resp)
						if (parseInt(resp) > 0) {
		...
		$('.modal-deseasAnular').on('shown.bs.modal', function() {
			$('#txtRazonAnular').focus();
		});
		...
		$('#btbSalvarVenta').click(function() {
			if ($('#txtCuantoPagaCliente').val() < parseFloat($('#h3CuentaFinal').text()) || $('#txtCuantoPagaCliente').val() == '') {
				...
				$.ajax({
					url: 'php/insertarVentaFinal.php',
					type: 'POST',
					data: {
						mesa: $('#idMesaSpan').text(),
						cuantoCobra: $('#txtCuantoPagaCliente').val(),
						idUser: $.JsonUsuario.idUsuario,
						idCli: 1, //$('#spanTipoCliente').text(),
						montoTotal: $('#idTotalSpan').text()
					}
		...
		$('#btnImprCta').click(function() {
			imprimirCuentaCliente();
		});
		...
		function imprimirCuentaCliente() {
			...
			$.each($('.contanedorDivsProductos .divUnSoloProducto'), function(i, dato) {
				if ($(dato).hasClass('divUnSoloDescuento')) {
					$.ticket.push({
						'id': $(dato).find('.h4NombreProducto').attr('id'),
						'nomProducto': $(dato).find('.cantidadProducto').text() + 'Dcto. ' + $(dato).find('.h4NombreProducto').text(),
						'cant': $(dato).find('.cantidadProducto').text(),
						'sub': $(dato).find('.valorTotalProducto').text()
					}); //montoDescontar
				} else {
		...
		$('.modal-buscarProducto').on('shown.bs.modal', function() {
			/*$('#txtParaFiltrarProducto').focus();*/

		});
		$('#btnCajaAgregarProducto').click(function() {
			listarProductos();
			$('.bs-callout').find('.panel-heading').addClass('collapsed').attr({
				'aria-expanded': 'false'
			});
		...
		$('.DetalleMesa').on('click', '.btnSumarProducto', function() {
			...
			$.ajax({
				url: 'php/sumarUnProductoAMesa.php',
				type: 'POST',
				data: {
					idProd: idProd,
					mesa: idmesa,
		...
		$('.DetalleMesa').on('click', '.btnRestarProducto', function() {
			...
			if (contenedor.find('.cantidadProducto').text() > 1) {
				$.ajax({
					url: 'php/restarUnProductoAMesa.php',
					type: 'POST',
					data: {
						prod: idProd,
						mesa: idmesa,
		...
		$('#txtCuantPagaClienteTarjet').keyup(function(e) {
			...
			if (resF >= 0) {
				$('#txtCuantPagaClienteEfect').val(resF.toFixed(2))
			} else {
				$('#txtCuantPagaClienteEfect').val('0.00')
			}
		});
		$('.modal-buscarProducto').on('click', '.btnAgregarProducto', function() {
			...
			var platoProd = '';
			if (padreMayor == 'RegTodosBebidas') {
				platoProd = 'divProdBebida'
			} else {
				platoProd = 'divFondos';
			}
			...
			if ($('.contanedorDivsProductos').find('#' + idProd).html() == null) {
				...
				$.ajax({
					url: 'php/insertarPedidoDetalle.php',
					type: 'POST',
					data: {
						idProd: idProd,
						precio: preccio,
						cantidad: 1,
						idPedido: $('#idPedidoMesa').text(),
						nota: ''
					}
				}).done(function(resp) {
					console.log(resp)
		...
		$('#btnAnularPedidov2').click(function() {
			if ($('#txtRazonAnular').val() == '') {
				$('.modal-deseasAnular .labelError').removeClass('hidden').find('.mensaje').text('Debe incluir una razón breve para guardar');
				...
				$.ajax({
					url: 'php/cancelarPedido.php',
					type: 'POST',
					data: {
						mesa: $('#idMesaSpan').text(),
						idUser: $.JsonUsuario.idUsuario,
						comentario: '«' + $('#txtRazonAnular').val() + '». ' + $.JsonUsuario.usuNombres
					}
				}).done(function(resp) {
					//console.log(resp)
		...
		$('#btnMoverMesa').click(function() {
			if ($('#txtDestinoDeMesa').val() <= 0 || $('#txtDestinoDeMesa').val() > 40 || $('#txtDestinoDeMesa').val() == '') {
				...
				$.ajax({
					url: 'php/updateMoverMesa.php',
					type: 'POST',
					data: {
						mesaAnt: $('#idMesaSpan').text(),
						mesaNuevo: $('#txtDestinoDeMesa').val()
					}
				}).done(function(data) {
					if (parseInt(data) > 0) {
				...
				$.each(JSON.parse(resp), function(i, dato) {
					...
					if (i == cantElem - 1) {
						if (itemsBar.length > 0) {
							$.ajax({
								url: 'printTicketBar.php',
								type: 'POST',
								data: {
									hora: moment().format('DD [de] MMMM [de] YYYY h:mm a'),
									numMesa: $('#spanNumMesa').text(),
									texto: itemsBar,
									usuario: $.JsonUsuario.usuNombres,
									obsBarra: ''
								}
		...
		$('#btnAplicarDscto').click(function() {
			...
			$.ajax({
				url: 'php/insertarPromocionEspecial.php',
				type: 'POST',
				data: {
		...
		$('#sltComprobanteEfectivo').change(function() {
			switch ($('#sltComprobanteEfectivo').val()) {
				case '0':
					$('#divDetalleBoleta').addClass('hidden');
					break;
				case '3':
		...
		function insertarAlFacturador() {
			...
			$.ajax({
				url: "http://127.0.0.1/restaurant/printTicketInterno.php",
				type: 'POST',
				data: {
					ticketera: 'CAJA',
